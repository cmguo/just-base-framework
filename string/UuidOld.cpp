...
namespace framework
{
    namespace string
    {
        ...
        UuidOld::bytes_type UuidOld::to_bytes() const
        {
            bytes_type bytes;
        ...
        void UuidOld::from_bytes(
            bytes_type const & bytes)
        {
            memcpy(&uuid_, bytes.elems, sizeof(uuid_));
        }

        UuidOld::bytes_type UuidOld::to_little_endian_bytes() const
        {
            bytes_type bytes;
            UUID uuid = uuid_;
        ...
        void UuidOld::from_little_endian_bytes(
            bytes_type const & bytes)
        {
            UUID uuid;
        ...
        UuidOld::bytes_type UuidOld::to_big_endian_bytes() const
        {
            bytes_type bytes;
            UUID uuid = uuid_;
        ...
        void UuidOld::from_big_endian_bytes(
            bytes_type const & bytes)
        {
            UUID uuid;
            memcpy(&uuid, bytes.elems, sizeof(uuid));
